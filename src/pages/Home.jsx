...
const reviews = [
  { text: "We drove up from Escanaba and had an absolute blast. The views of the bay are worth the trip alone. Can't wait to come back next summer.", attr: "— Google Review" },
  { text: "Best-kept secret in the UP. The greens are unique and the prices are honest. We played 18 holes and never felt rushed.", attr: "— Google Review" },
  { text: "Friendly staff, gorgeous setting, and cold beer waiting at the clubhouse. That's all you need.", attr: "— Google Review" },
]
          ...
          {[
            {
              ...
              text: 'Nahma Golf Club is one of the oldest public courses in Michigan\'s Upper Peninsula. Over a century of rounds played on these same fairways.'
            },
            {
              ...
              text: 'Situated right on the Lake Michigan shoreline, the course offers views that no inland course can match. The bay is your backdrop on nearly every hole.'
            },
            {
              ...
              text: 'Show up, pay your green fee, and play. No reservations needed. Walk-ins are always welcome at Nahma.'
            }
          ].map((col, i) => (
            <div key={i} className="text-cream/90">
              ...
              <h3 className="font-serif text-xl text-sand mb-3">{col.heading}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-charcoal/80 font-sans leading-relaxed">
              <p>Nahma Golf Club has been welcoming golfers to the shores of Big Bay de Noc since 1922. The layout winds through mature trees and along open fairways with bay views that will stop you mid-swing.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                text: 'Three nights a week, May through September. Men\'s, Women\'s, and an open scramble for everyone.',
                link: '/leagues/',
      ...
      <section className="bg-sand/30 border-t border-b border-sand/40 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="font-sans text-lg font-medium text-charcoal">4.8 stars on Google</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {reviews.map((r, i) => (
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="font-serif text-charcoal text-3xl mb-6">Rapid River, Michigan</h2>
