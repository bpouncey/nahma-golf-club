    ...
    <>
      ...
      <section className="bg-forest py-14 text-center">
        <div className="max-w-lg mx-auto px-4">
          <h2 className="font-serif text-cream text-2xl mb-4">Ready to put these numbers to work?</h2>
          <p className="text-cream/70 font-sans text-sm mb-6">Green fees start at $18. Walk-ins always welcome.</p>
