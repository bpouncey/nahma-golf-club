    ...
    <>
      ...
      <section className="bg-forest py-14 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-cream/70 font-sans text-lg">Walk up, pay, and play. No tee times. Green fees start at $18 for nine holes.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-charcoal/60 font-sans text-sm mb-4">Season runs May through September. Memberships include UPGA green fee rates all season.</p>
          <p className="text-center text-charcoal/55 font-sans text-xs mb-10">A seasonal membership pays for itself quickly if you play regularly. Members also get UPGA rates on cart rentals and access to all three weekly leagues.</p>
      ...
      <section className="bg-forest py-14">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="font-serif text-cream text-2xl mb-3">Ready to play Nahma?</h2>
          <p className="text-cream/70 font-sans text-sm mb-6">No tee time needed. Show up, pay your green fee, and you're off. Escanaba and Gladstone are about 20 minutes away.</p>
