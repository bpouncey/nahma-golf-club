    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-charcoal/80 font-sans leading-relaxed">
              <p>Big Bay de Noc is the northern arm of Green Bay, a body of water known for its clarity, its fishing, and its dramatic light on summer evenings. Nahma Golf Club sits right on that shoreline. If you're coming from Escanaba or Gladstone, the drive is under 30 minutes and the view when you arrive makes it worth the trip.</p>
      ...
      <section className="py-20 bg-sand/20 border-t border-b border-sand/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-5 text-charcoal/80 font-sans leading-relaxed text-left max-w-2xl mx-auto">
            ...
            <p>Pace of play is comfortable here. Nine holes typically runs about two hours walking. No one is rushing you. This is golf the way it was meant to be played: relaxed, scenic, and at a pace that lets you actually enjoy the setting.</p>
      ...
      <section className="bg-forest py-14 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <p className="text-cream/70 font-sans text-sm mb-2">Good course. Honest prices.</p>
          <h2 className="font-serif text-cream text-3xl mb-6">Nine holes for $18. Eighteen holes for $28. No tee times, no dress code, no fuss.</h2>
